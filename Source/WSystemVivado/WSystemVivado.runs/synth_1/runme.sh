...
HD_PWD='D:/GitHub/sutech-fpga-1402/WSystemVivado/WSystemVivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WSystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WSystem.tcl
