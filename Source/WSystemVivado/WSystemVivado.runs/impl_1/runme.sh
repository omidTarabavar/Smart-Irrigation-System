...
HD_PWD='D:/GitHub/sutech-fpga-1402/WSystemVivado/WSystemVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WSystem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WSystem.tcl -notrace
